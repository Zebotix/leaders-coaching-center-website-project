...
export default function Contact() {
  ...
  return (
    <>
      ...
      <main
        id='contact'
        className='min-h-screen py-16 lg:px-20 shadow-sm bg-linear-to-b from-blue-50 to-white'
      >
        <div className='max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-start'>
          ...
          >
            <h1 id='contact-heading' className='text-2xl md:text-3xl font-extrabold mb-2'>
              Get in touch with <span className='text-yellow-500'>Leaders Coaching Center</span>
            </h1>
